...
export const metadata: Metadata = { title: "Pesanan Saya — SkripsiMentor" };
...
export default async function MyOrdersPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-slate-500">{orders.length} pesanan</p>
              ...
              {orders.map((o) => {
                ...
                return (
                  <tr key={o.id} className="hover:bg-slate-50/60">
                    ...
                    <td className="px-4 py-3 font-medium text-slate-800">{o.package.name}</td>
                    ...
                    <td className="px-4 py-3 text-right">
                      <Link href={`/dashboard/orders/${o.id}`} className="text-xs font-semibold text-indigo-600 hover:underline">
                        Detail →
                      </Link>
                    </td>
                  </tr>
